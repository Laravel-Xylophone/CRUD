...
trait Stats
{
    ...
    /**
     * Send usage statistics to the XylophoneForLaravel.com website.
    ...
    private function sendUsageStats()
    {
        ...
        $url = 'https://xylophoneforlaravel.com/api/stats';
        $method = 'PUT';
        $stats = [
            ...
            'XYLOPHONE_CRUD_VERSION' => \PackageVersions\Versions::getVersion('xylophone/crud') ?? false,
            'XYLOPHONE_LICENSE'      => config('xylophone.base.license_code') ?? false,
        ];
