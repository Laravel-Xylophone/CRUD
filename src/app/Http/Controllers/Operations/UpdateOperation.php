...
namespace Xylophone\CRUD\app\Http\Controllers\Operations;
...
trait UpdateOperation
{
    ...
    public function edit($id)
    {
        ...
        $this->data['title'] = $this->crud->getTitle() ?? trans('xylophone::crud.edit').' '.$this->crud->entity_name;

        $this->data['id'] = $id;

        // load the view from /resources/views/vendor/xylophone/crud/ if it exists, otherwise load the one in the package
    ...
    public function update()
    {
        ...
        \Alert::success(trans('xylophone::crud.update_success'))->flash();
