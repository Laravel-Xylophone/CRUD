...
trait Settings
{
    ...
    public function getOperationSetting(string $key, $operation = null)
    {
        ...
        return $this->get($operation.'.'.$key) ?? config('xylophone.crud.operations.'.$this->getCurrentOperation().'.'.$key) ?? null;
    }
    ...
    /**
     * Automatically set values in config file (config/xylophone/crud)
    ...
    public function loadDefaultOperationSettingsFromConfig($configPath = null)
    {
        ...
        $configPath = $configPath ?? 'xylophone.crud.operations.'.$operation;
