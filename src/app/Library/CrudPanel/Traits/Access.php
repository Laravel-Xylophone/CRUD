...
use Xylophone\CRUD\app\Exceptions\AccessDeniedException;
...
trait Access
{
     ...
     * @param string $operation
     *
     * @throws \Xylophone\CRUD\Exception\AccessDeniedException in case the operation is not enabled
     *
     * @return bool
     */
    ...
    {
        if (! $this->get($operation.'.access')) {
            throw new AccessDeniedException(trans('xylophone::crud.unauthorized_access', ['access' => $operation]));
        }
