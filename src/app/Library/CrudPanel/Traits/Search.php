...
trait Search
{
    ...
    */
    ...
    public function getResponsiveTable()
    {
        ...
        return config('xylophone.crud.operations.list.responsiveTable');
    }
    ...
    public function getPersistentTable()
    {
        ...
        return config('xylophone.crud.operations.list.persistentTable');
    }
    ...
    public function getPersistentTableDuration()
    {
        ...
        return config('xylophone.crud.operations.list.persistentTableDuration', false);
    }
    ...
    private function getCellViewName($column)
    {
        ...
        if (isset($column['type'])) {
            ...
            if (view()->exists('vendor.xylophone.crud.columns.'.$column['type'])) {
                return 'vendor.xylophone.crud.columns.'.$column['type'];
            }
