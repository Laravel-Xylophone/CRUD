...
namespace Xylophone\CRUD\app\Library\CrudPanel\Traits;
...
trait Views
{
    ...
    {
        return $this->get('create.contentClass') ?? config('xylophone.crud.operations.create.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('list.contentClass') ?? config('xylophone.crud.operations.list.contentClass', 'col-md-12');
    }
    ...
    {
        return $this->get('show.contentClass') ?? config('xylophone.crud.operations.show.contentClass', 'col-md-8 col-md-offset-2');
    }
    ...
    {
        return $this->get('update.contentClass') ?? config('xylophone.crud.operations.update.contentClass', 'col-md-8 bold-labels');
    }
    ...
    {
        return $this->get('reorder.contentClass') ?? config('xylophone.crud.operations.reorder.contentClass', 'col-md-8 col-md-offset-2');
    }
    ...
    {
        return $this->get('revisions.timelineContentClass') ?? config('xylophone.crud.operations.revisions.timelineContentClass', 'col-md-12');
    }
