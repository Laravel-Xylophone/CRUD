...
namespace Xylophone\CRUD\app\Library\CrudPanel;

use Xylophone\CRUD\app\Library\CrudPanel\Traits\Access;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\AutoFocus;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\AutoSet;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Buttons;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Columns;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Create;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Delete;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Errors;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\FakeColumns;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\FakeFields;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Fields;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Filters;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\HeadingsAndTitles;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Macroable;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Operations;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Query;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Read;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Reorder;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\SaveActions;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Search;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Settings;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Tabs;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Update;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Validation;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\Views;
use Xylophone\CRUD\app\Library\CrudPanel\Traits\ViewsAndRestoresRevisions;
...
class CrudPanel
{
     ...
     * - $this->crud->setRoute(config('xylophone.base.route_prefix').'/article')
     * - $this->crud->setRouteName(config('xylophone.base.route_prefix').'.article')
     * - $this->crud->route = config('xylophone.base.route_prefix')."/article"
     *
     * @return string
     */
