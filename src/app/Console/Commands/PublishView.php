...
class PublishView extends Command
{
     ...
     * @var string
     */
    protected $name = 'xylophone:publish';
     ...
     * @var string
     */
    protected $signature = 'xylophone:publish
     ...
     * @var string
     */
    protected $description = 'Publishes a Xylophone view so you can make changes in your project. Please note you won\'t be getting any updates for these files after you publish them - Xylophone will be using YOUR file, instead of the one in vendor.';
     ...
     * @var string
     */
    public $sourcePath = 'vendor/xylophone/crud/src/resources/views/';
     ...
     * @var string
     */
    public $destinationPath = 'resources/views/vendor/xylophone/';
