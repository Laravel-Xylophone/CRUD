...
@php
  $defaultBreadcrumbs = [
    ...
    trans('xylophone::crud.edit') => false,
  ];
...
@section('header')
	<section class="container-fluid">
	  <h2>
        ...
        <small>{!! $crud->getSubheading() ?? trans('xylophone::crud.edit').' '.$crud->entity_name !!}.</small>
		  ...
		  {!! method_field('PUT') !!}
		    ...
		    @endif
		      ...
		      @if(view()->exists('vendor.xylophone.crud.form_content'))
		      	@include('vendor.xylophone.crud.form_content', ['fields' => $crud->fields(), 'action' => 'edit'])
		      @else
