<!-- PAGE OR LINK field -->
<!-- Used in Xylophone\MenuCRUD -->

<?php
    $field['options'] = [
        'page_link'     => trans('xylophone::crud.page_link'),
        'internal_link' => trans('xylophone::crud.internal_link'),
        'external_link' => trans('xylophone::crud.external_link'),
    ];
...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="link"
                    placeholder="{{ trans('xylophone::crud.page_link_placeholder') }}"
    ...
    echo 'd-none';
                ...
                <input
                    ...
                    class="form-control"
                    name="link"
                    placeholder="{{ trans('xylophone::crud.internal_link_placeholder', ['url', url(config('xylophone.base.route_prefix').'/page')]) }}"
