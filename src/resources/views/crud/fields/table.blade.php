...
<div data-field-type="table" data-field-name="{{ $field['name'] }}" @include('crud::inc.field_wrapper_attributes') >
    ...
    <div class="array-container form-group">
        ...
        <table class="table table-sm table-striped m-b-0" data-items="{{ $items }}" data-max="{{$max}}" data-min="{{$min}}" data-maxErrorTitle="{{trans('xylophone::crud.table_cant_add', ['entity' => $item_name])}}" data-maxErrorMessage="{{trans('xylophone::crud.table_max_reached', ['max' => $max])}}">
        ...
        <div class="array-controls btn-group m-t-10">
            <button class="btn btn-sm btn-light" type="button" data-button-type="addItem"><i class="fa fa-plus"></i> {{trans('xylophone::crud.add')}} {{ $item_name }}</button>
        </div>
