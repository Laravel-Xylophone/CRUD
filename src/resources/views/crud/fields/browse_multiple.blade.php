...
if (!isset($field['wrapperAttributes']) || !isset($field['wrapperAttributes']['data-init-function']))
{
    ...
    if ($multiple) {
        $field['wrapperAttributes']['data-popup-title'] = trans('xylophone::crud.select_files');
        $field['wrapperAttributes']['data-multiple'] = "true";
    } else {
        $field['wrapperAttributes']['data-popup-title'] = trans('xylophone::crud.select_file');
