...
@php
  $defaultBreadcrumbs = [
    ...
    trans('xylophone::crud.reorder') => false,
  ];
...
<div class="container-fluid">
    <h2>
        ...
        <small>{!! $crud->getSubheading() ?? trans('xylophone::crud.reorder').' '.$crud->entity_name_plural !!}.</small>
...
<div class="row mt-4">
    <div class="{{ $crud->getReorderContentClass() }}">
        <div class="card p-4">
            <p>{{ trans('xylophone::crud.reorder_text') }}</p>
        ...
        <button id="toArray" class="btn btn-success" data-style="zoom-in"><i class="fa fa-save"></i> {{ trans('xylophone::crud.save') }}</button>
    </div>
</div>
@endsection
...
<link rel="stylesheet" href="{{ asset('packages/xylophone/crud/css/reorder.css') }}">
@endsection

@section('after_scripts')
<script src="{{ asset('packages/xylophone/crud/js/crud.js') }}" type="text/javascript" ></script>
<script src="{{ asset('packages/xylophone/crud/js/reorder.js') }}" type="text/javascript" ></script>
...
<script type="text/javascript">
    ...
    $('#toArray').click(function(e){
        ...
        .done(function() {
            new Noty({
                type: "success",
                text: "<strong>{{ trans('xylophone::crud.reorder_success_title') }}</strong><br>{{ trans('xylophone::crud.reorder_success_message') }}"
            }).show();
          })
        .fail(function() {
            new Noty({
                type: "error",
                text: "<strong>{{ trans('xylophone::crud.reorder_error_title') }}</strong><br>{{ trans('xylophone::crud.reorder_error_message') }}"
            }).show();
          })
        .always(function() {
