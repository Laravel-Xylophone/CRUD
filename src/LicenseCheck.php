...
trait LicenseCheck
{
    ...
    private function checkLicenseCodeExists()
    {
        ...
        if (! $this->validCode(config('xylophone.base.license_code'))) {
            \Alert::add('warning', "<strong>You're using unlicensed software.</strong> Please ask your web developer to <a target='_blank' class='alert-link text-white' href='http://xylophoneforlaravel.com'>purchase a license code</a> to hide this message.");
        }
    }
