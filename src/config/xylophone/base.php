...
return [
    ...
    */
    ...
    'project_name' => 'Xylophone Admin Panel',
    ...
    'styles' => [
        'packages/xylophone/base/css/bundle.css',
    ...
    // Show powered by Laravel Xylophone in the footer? true/false
    ...
    'scripts' => [
        ...
        'packages/xylophone/base/js/bundle.js',
    ...
    'cachebusting_string' => \PackageVersions\Versions::getVersion('xylophone/crud'),
    ...
    */
    ...
    'middleware_class' => [
        ...
        // \Xylophone\CRUD\app\Http\Middleware\UseXylophoneAuthGuardInsteadOfDefaultAuthGuard::class,
    ],
    ...
    |--------------------------------------------------------------------------
    */
    // Change the view namespace in order to load a different theme than the one Xylophone provides.
    // You can create child themes yourself, by creating a view folder anywhere in your resources/views
    // and choosing that view_namespace instead of the default one. Xylophone will load a file from there
    // if it exists, otherwise it will load it from the default namespace ("xylophone::").

    'view_namespace' => 'xylophone::',
