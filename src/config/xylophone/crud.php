    ...
    */
    ...
    'operations' => [
        ...
        'list' => [
            ...
            // whenever the user tries to see that page, xylophone loads the previous pagination and filtration
            ...
            'pageLengthMenu' => [[10, 25, 50, 100, -1], [10, 25, 50, 100, 'xylophone::crud.all']],
