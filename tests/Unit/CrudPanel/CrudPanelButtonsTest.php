...
use Xylophone\CRUD\app\Library\CrudPanel\Traits\CrudButton;
...
class CrudPanelButtonsTest extends BaseCrudPanelTest
{
    ...
    public function testAddButtonFromView()
    {
        ...
        $xylophoneButtonViewPackage = 'crud::buttons.';
        ...
        $this->assertEquals($xylophoneButtonViewPackage.$viewName, $actualButton->content);
        $this->assertEquals($expectedButton->stack, $actualButton->stack);
    }
