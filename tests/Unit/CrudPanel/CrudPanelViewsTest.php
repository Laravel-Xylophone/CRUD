...
class CrudPanelViewsTest extends BaseCrudPanelTest
{
    ...
    {
        Config::set('xylophone.crud.operations.create.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.create.contentClass'), $this->crudPanel->getCreateContentClass());
    }
    ...
    {
        Config::set('xylophone.crud.operations.update.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.update.contentClass'), $this->crudPanel->getEditContentClass());
    }
    ...
    public function testGetUpdateContentClassFromConfig()
    {
        ...
        $this->assertEquals(Config::get('xylophone.crud.operations.update.contentClass'), $this->crudPanel->getUpdateContentClass());
    }
    ...
    {
        Config::set('xylophone.crud.operations.show.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.show.contentClass'), $this->crudPanel->getShowContentClass());
    }
    ...
    {
        Config::set('xylophone.crud.operations.list.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.list.contentClass'), $this->crudPanel->getListContentClass());
    }
    ...
    {
        Config::set('xylophone.crud.operations.reorder.contentClass', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.reorder.contentClass'), $this->crudPanel->getReorderContentClass());
    }
    ...
    {
        Config::set('xylophone.crud.operations.revisions.timelineContent', $this->customContentClass);

        $this->assertEquals(Config::get('xylophone.crud.operations.revisions.timelineContent'), $this->crudPanel->getRevisionsTimelineContentClass());
    }
}
